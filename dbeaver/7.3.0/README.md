...
1. Remove the docker image: `docker image rm seudev/dbeaver:7.3.0`
1. Remove the version folder: `rm -rf ~/seudev/dockerized-apps/dbeaver/7.3.0`
1. Remove the shortcut from the Desktop: `rm -f ~/Desktop/com.seudev.dbeaver.7.3.0.desktop`
1. Remove the shortcut from the Start Menu: `rm -f ~/.local/share/applications/com.seudev.dbeaver.7.3.0.desktop`
